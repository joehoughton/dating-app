...
namespace DatingApp.API.Data
{
    public class DatingRepository : IDatingRepository
    {
        ...
        {
            return await _context.Likes.Include(l => l.Likee).FirstOrDefaultAsync(u => u.LikerId == userId && u.LikeeId == recipientId);
        }
        ...
        public async Task<IEnumerable<Message>> GetMessageThread(int userId, int recipientId)
        {
            ...
            var unreadMessages = messages.Where(m => m.DateRead == null && m.Recipient.Id == userId).ToList();
